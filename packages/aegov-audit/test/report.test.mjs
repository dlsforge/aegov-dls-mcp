...
describe("TDRA checklist mirror", () => {
  ...
  test("clean input yields no-automated-findings, never a pass claim", () => {
    ...
    assert.deepEqual(
      ...
      // prettier-ignore
      ["1.1", "2.2", "2.3", "2.6", "2.7", "2.8", "2.9", "2.10", "2.12", "2.21", "2.23", "2.35",
       "2.38", "2.42", "3.1", "3.2", "3.4", "3.6", "3.8", "3.9", "3.10", "3.12", "3.13", "3.14",
       "3.15", "3.23", "3.24", "3.25", "3.26", "3.27", "3.28", "3.29", "3.30", "3.31", "3.32",
