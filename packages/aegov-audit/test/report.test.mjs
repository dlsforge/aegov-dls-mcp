...
describe("TDRA checklist mirror", () => {
  ...
  test("clean input yields no-automated-findings, never a pass claim", () => {
    ...
    assert.deepEqual(
      ...
      // prettier-ignore
      ["1.1", "1.5", "1.15", "2.2", "2.3", "2.6", "2.7", "2.8", "2.9", "2.10", "2.12",
       "2.21", "2.23", "2.26", "2.28", "2.31", "2.33", "2.35", "2.38", "2.40", "2.42", "3.1",
       "3.2", "3.4", "3.5", "3.6", "3.8", "3.9", "3.10", "3.12", "3.13", "3.14", "3.15", "3.19",
       ...
       "3.53", "3.54", "3.57", "3.58", "3.59", "3.60", "3.61", "3.62", "3.63", "3.64"],
